 ...
 *
 */
@XmlType(propOrder = { "numeroOperacion", "tdiepco1", "fperceh1", "tipoIngreso", "rfcRetExp", "importe1", "importe4" })
public class ConsultarDeclaracionISRPersonaFisica1317cForma13aDTO implements Serializable {

    @SuppressWarnings("compatibility:6552912572328702986")
    ...
    private int retencionDeduccion;
    ...
    public void setRetencionDeduccion(int retencionDeduccion) {
        this.retencionDeduccion = retencionDeduccion;
    }

    @XmlTransient
    public int getRetencionDeduccion() {
        return retencionDeduccion;
    }
    ...
    public String getParameterReport() {
        ...
        sb.append("retencionDeduccion:");
        sb.append(this.getRetencionDeduccion());
