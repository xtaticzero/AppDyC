...
public class ConsultarCaratulaDeclaracionSociedadIntegradora3Forma3DTO implements Serializable {

    @SuppressWarnings("compatibility:-5520173919101013257")
    ...
    private String vC110004;
    private int vC120007;
    private int vC130005;
    ...
    public void setVC110004(String vC110004) {
        this.vC110004 = vC110004;
    }

    public String getVC110004() {
        return vC110004;
    }
    ...
    public void setVC130005(int vC130005) {
        this.vC130005 = vC130005;
    }

    public int getVC130005() {
        return vC130005;
    }
