 ...
 *
 */
public class ConsultarDeclaracionISRPersonaFisica1317cForma13DidMapper implements RowMapper<ConsultarDeclaracionISRPersonaFisica1317cForma13DidDTO> {

    public ConsultarDeclaracionISRPersonaFisica1317cForma13DidDTO mapRow(ResultSet resultSet,
                                                                          int rowNum) throws SQLException {
        ConsultarDeclaracionISRPersonaFisica1317cForma13DidDTO declaracionISRPersonaFisica1317aDecDto =
            new ConsultarDeclaracionISRPersonaFisica1317cForma13DidDTO();
