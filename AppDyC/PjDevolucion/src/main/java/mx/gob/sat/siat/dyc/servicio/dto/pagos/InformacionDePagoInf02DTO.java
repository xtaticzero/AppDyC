...
public class InformacionDePagoInf02DTO  implements Serializable {

    @SuppressWarnings("compatibility:4946968991869168961")
    ...
    public String getParameterReport(){
        ...
        sb.append("c_dec_cplearv1:" + this.getCDecCplearv1() + ", ");
