 ...
 *
 */
public class ConsultarDeclaracionISRPersonaFisica1317aDecMapper implements RowMapper<ConsultarDeclaracionISRPersonaFisica1317aDecDTO> {

    public ConsultarDeclaracionISRPersonaFisica1317aDecDTO mapRow(ResultSet resultSet,
                                                                   int rowNum) throws SQLException {
        ConsultarDeclaracionISRPersonaFisica1317aDecDTO declaracionISRPersonaFisica1317aDecDto =
            new ConsultarDeclaracionISRPersonaFisica1317aDecDTO();
