...
public class ConsultarDeclaracionISRPersonaFisica1317aForma13aDTO implements Serializable {

    @SuppressWarnings("compatibility:-2859766778917000116")
    ...
    private int importe1;
    private int importe4;
    ...
    public void setImporte1(int importe1) {
        this.importe1 = importe1;
    }

    public int getImporte1() {
        return importe1;
    }

    public void setImporte4(int importe4) {
        this.importe4 = importe4;
    }

    public int getImporte4() {
        return importe4;
    }
