 ...
 *
 */
public class ConsultarDeclaracionISRPersonaFisica1317bAnexo1Mapper implements RowMapper<ConsultarDeclaracionISRPersonaFisica1317bAnexo1DTO> {

    public ConsultarDeclaracionISRPersonaFisica1317bAnexo1DTO mapRow(ResultSet resultSet,
                                                                      int rowNum) throws SQLException {
        ConsultarDeclaracionISRPersonaFisica1317bAnexo1DTO declaracionISRPersonaFisica1317aDecDto =
            new ConsultarDeclaracionISRPersonaFisica1317bAnexo1DTO();
        ...
        declaracionISRPersonaFisica1317aDecDto.setDC105736(resultSet.getBigDecimal("d_c1_05736"));
