 ...
 * @date  $Date$
 */
public class SiosConsultaPagoTramiteConceptoStoredProcedure extends StoredProcedure {

    public SiosConsultaPagoTramiteConceptoStoredProcedure() {
        super();
    }
     ...
     */
    public SiosConsultaPagoTramiteConceptoStoredProcedure(JdbcTemplate jdbcTemplate, String callStoreProcedure) {
    ...
    public DeclaracionDwhVO siosConsultaPagoTramiteConcepto(IcepVO icep) throws SQLException{
