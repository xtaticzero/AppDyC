...
@XmlType(propOrder =
         { "vNNumeroOperacion", "vFechaCausacion", "vFperceh1", "vImpidee1", "vIapidne1", "vImpfdee1",
           "vIapfdne1", "vTdiepco1", "vC118228", "vC110004", "vC120007", "vC130005", "vI201010",
...
public class ConsultarCaratulaDeclaracionSociedadIntegradora3RegDTO implements Serializable {

    @SuppressWarnings("compatibility:85735648236019513")
    ...
    private BigDecimal vC110004;
    private BigDecimal vC120007;
    private BigDecimal vC130005;
    ...
    public void setVC110004(BigDecimal vC110004) {
        this.vC110004 = vC110004;
    }

    public BigDecimal getVC110004() {
        return vC110004;
    }
    ...
    public void setVC130005(BigDecimal vC130005) {
        this.vC130005 = vC130005;
    }

    public BigDecimal getVC130005() {
        return vC130005;
    }
