...
package mx.gob.sat.siat.dyc.servicio.dao.pagos;
 ...
 *
 */
public interface ConsultarPagosElectronicosDAO {

    List<ConsultarPagosElectronicosAnioDTO> consultaRegistrosPorAnio(ConsultarPagosElectronicosAnioDTO consultarPagosElectronicosAnioDto);
