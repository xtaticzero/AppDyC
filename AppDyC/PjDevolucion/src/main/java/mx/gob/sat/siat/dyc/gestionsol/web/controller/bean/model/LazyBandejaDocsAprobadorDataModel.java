...
public class LazyBandejaDocsAprobadorDataModel extends LazyDataModel<BandejaDocumentosDTO> {

    private static final long serialVersionUID = -6175784111780918502L;

    private static final Logger LOGGER = Logger.getLogger(LazyBandejaDocsAprobadorDataModel.class);

    private transient BandejaDocumentosService bandejaDocumentosSer;
    ...
    public LazyBandejaDocsAprobadorDataModel() {
        super();
    }

    public LazyBandejaDocsAprobadorDataModel(BandejaDocumentosService bandejaDocumentosSer,
    ...
    public List<BandejaDocumentosDTO> load( int first, int pageSize, String sortField, SortOrder sortOrder,
        ...
        try {
            ...
            nReg = bandejaDocumentosSer.countBuscarBandejaDoc( numEmpleadoStr, numControlFiltrado, rfcFiltrado ).intValue();
            this.setRowCount(nReg);
            this.datasource = bandejaDocumentosSer.buscarBandejaDoc(numEmpleadoStr, numControlFiltrado, rfcFiltrado, paginador);
