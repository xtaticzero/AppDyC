 ...
 *
 */
public class ConsultarDeclaracionISRPersonaFisica1317cForma13aMapper implements RowMapper<ConsultarDeclaracionISRPersonaFisica1317cForma13aDTO> {

    public ConsultarDeclaracionISRPersonaFisica1317cForma13aDTO mapRow(ResultSet resultSet,
                                                                        int rowNum) throws SQLException {
        ConsultarDeclaracionISRPersonaFisica1317cForma13aDTO declaracionISRPersonaFisica1317aDecDto =
            new ConsultarDeclaracionISRPersonaFisica1317cForma13aDTO();
