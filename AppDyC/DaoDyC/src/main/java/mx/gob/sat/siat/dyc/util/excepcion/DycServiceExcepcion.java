 ...
 * @author GAER8674
 */
public class DycServiceExcepcion extends DycBaseExcepcion{
    public DycServiceExcepcion(IDycCodigoError codigoError, List<DycLogEstadoVariable> estadoVariables) {
    ...
    public DycServiceExcepcion(IDycCodigoError codigoError, List<DycLogEstadoVariable> estadoVariables, Throwable cause) {
        super(codigoError.getDescripcion()+DycLogUtil.generarMsgEstadoVariables(estadoVariables), cause);
        this.setCodigoError(codigoError);
        this.setEstadoVariables(estadoVariables);
    }
    
    public DycServiceExcepcion(IDycCodigoError codigoError, List<DycLogEstadoVariable> estadoVariables, DycBaseExcepcion cause) {
        super(codigoError.getDescripcion()+DycLogUtil.generarMsgEstadoVariables(estadoVariables), cause);
        this.setCodigoError(codigoError);
        this.setEstadoVariables(estadoVariables);
    }
