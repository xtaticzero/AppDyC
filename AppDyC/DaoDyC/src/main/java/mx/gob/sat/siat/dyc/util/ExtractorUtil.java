...
public final class ExtractorUtil {
    ...
    {
        if(origen == null){
            return "El objeto recibido es NULO";
        }
        ...
        for (Field field : campos) {
            ...
            if (existeMetodo(metodos, PREFIJO_GET + nombre)) {
                ...
                if (field.getType().getName().startsWith(PREFIJO_PAQUETE)) {
                    ...
                    result.append(
                            tabulador.toString() + CARACTER_TAB + fieldName + " = " + valorObjeto + CARACTER_SALTO_DE_LINEA);
                }
            }
     ...
     * */
     private static String obtenerDatosMap(Object mapeo) {
         ...
         try {
             ...
             log.info(ConstantesDyC1.TEXTO_1_ERROR_DAO + ex.getMessage());
         }
         return result;
     }
