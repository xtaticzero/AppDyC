...
package mx.gob.sat.mat.buzonnotif.util.constantes;

/**
 *
 * @author GAER8674
 */
public final class BuzonNotifConstantes {
    private BuzonNotifConstantes(){}
    
    
    // PROPERTIES
    public static final String PROPERTIES_KEY_WSDL                    = "${buzonnotif.service.wsdl}";
