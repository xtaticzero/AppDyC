...
/**
 * DTO para el catalogo DYCC_SUBTRAMITE
 * @author  Alfredo Ramirez
 * @since   31/03/2014
 */
public class DyccSubTramiteDTO implements Serializable {

    @SuppressWarnings("compatibility:6122002625074038350")
    ...
    public DyccSubTramiteDTO() {
    }

    public DyccSubTramiteDTO(String descripcion, Date fechaFin, Date fechaInicio, Integer idSubTipoTramite) {
