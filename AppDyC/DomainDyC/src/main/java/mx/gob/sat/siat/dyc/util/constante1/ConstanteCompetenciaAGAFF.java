...
import static mx.gob.sat.siat.dyc.util.constante1.ConstantesDyC2.ZERO_VALUE;

/**
 *
 * @author jose.aguilarl
 */
public final class ConstanteCompetenciaAGAFF {

    private ConstanteCompetenciaAGAFF() {
        super();
    }
        //Competencia de AGAFF
    ...
    public static final BigDecimal NUEVO_BIGDECIMAL_CERO = new BigDecimal(ZERO_VALUE);
