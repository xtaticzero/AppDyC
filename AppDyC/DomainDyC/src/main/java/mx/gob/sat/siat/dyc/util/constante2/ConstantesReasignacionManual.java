 ...
 */
public final class ConstantesReasignacionManual {

    private ConstantesReasignacionManual() {
        super();
    }
    /*ConstantesDyC para caso de uso reasiganar manuelmanete sol*/
    ...
    public static final String OCULTAR_DIALOGO_LISTA_DICTAMIN = "listarDictaminReasig.hide();";
    public static final String MOSTRAR_DIALOGO_ADM_DESTINO = "lstAdmDestino.show();";
    public static final String OCULTAR_DIALOGO_ADM_DESTINO = "lstAdmDestino.hide();";
    public static final String MOSTRAR_DIALOGO_LISTA_DICTAMIN_DESTINO = "listarDictaminReasigDestino.show();";
    public static final String OCULTAR_DIALOGO_LISTA_DICTAMIN_DESTINO = "listarDictaminReasigDestino.hide();";
    public static final String OCULTAR_DIALOGO_LISTA_TRAMITES = "listarSolicitudesDialog2.hide()";
    ...
    public static final String MOSTRAR_CONFIRM_DIALOG_CONTINUOC = "cfmCDWv2.show();";
    public static final String MOSTRAR_CONFIRM_DIALOG_REINICIOC = "cfmNoWv2.show();";
    public static final String MOSTRAR_CONFIRM_DIALOG_ASIGNACION_CENTRAL = "cfmCReasignacion.show();";
